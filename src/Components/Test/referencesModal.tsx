                          ...
                          <div className="overflow-auto h-[30rem]">
                            {references.map((refrence: any, index: number) => (
                              <div key={index}>
                                <div
                                  key={index}
                                  className="grid   gap-y-0 md:grid-cols-5 sm:grid-cols-4 xs:grid-cols-3 lg:grid-cols-7 w-full  px-3"
                                >
                                  ...
                                  <button
                                    type="button"
                                    className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-3 my-auto float-right  ml-auto w-fit h-10 text-sm rounded"
