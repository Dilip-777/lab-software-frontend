...
const charCount = (editor: any) => editor.getContent({ format: "text" }).length;
...
export default function Test() {
  ...
  const handleInit = (value: string, editor: any) => {
