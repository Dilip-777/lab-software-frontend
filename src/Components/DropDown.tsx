...
export default function DropDown({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute left-0 z-10 mt-0 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            {navItem.dropdownItems
              ?.filter((n) => privileges.includes(n.name))
              ?.map((item) => (
